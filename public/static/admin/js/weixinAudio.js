(function() {
	$.fn.weixinAudio = function(callback, options) {
		var $this = $(this);
		var defaultoptions = {
			autoplay:false,
			src:'',
		...
		$this.each(function(index,element) {
			...
			console.log(obj['weixinAudio'+index]);
